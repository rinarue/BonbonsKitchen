...
public class GameEngine {
    ...
    private List<Ingredient> initializeIngredients() {
        ...
        list.add(new Ingredient("Milk", 2.0, "file:main.resources.assets/ingredients/milk.png"));
        list.add(new Ingredient("Egg", 1.5, "file:main.resources.assets/ingredients/egg.png"));
        list.add(new Ingredient("Flour", 1.0, "file:main.resources.assets/ingredients/flour.png"));
        list.add(new Ingredient("Sugar", 1.2, "file:main.resources.assets/ingredients/sugar.png"));
        list.add(new Ingredient("Butter", 2.5, "file:main.resources.assets/ingredients/butter.png"));
        // Add more as needed
        return list;
    }
